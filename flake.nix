  ...
  outputs = { self, nixpkgs, crane, fenix, flake-utils, ... }:
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        iconOrCargo = path: type:
          (iconFilter path) || (craneLib.filterCargoSources path type);
        ...
        nuhxboard = craneLib.buildPackage (commonArgs // {
          ...
          postInstall = ''
            ...
            wrapProgram $out/bin/nuhxboard --prefix LD_LIBRARY_PATH : "${
      ...
      in {
        ...
        packages = {
          ...
          nuhxboard-llvm-coverage = craneLibLLvmTools.cargoLlvmCov
        ...
        devShells.default = craneLib.devShell {
          ...
          packages = with pkgs; [ cargo-dist cargo-release ];
